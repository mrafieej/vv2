...
class Listing(models.Model):
    ...
    image_2 = models.ImageField(upload_to='media/listings/', default=None)
    image_3 = models.ImageField(upload_to='media/listings/', default=None)
    image_4 = models.ImageField(upload_to='media/listings/', default=None)
    image_5 = models.ImageField(upload_to='media/listings/', default=None)
